...
class SmashUI {
  ...
  static const double DEFAULT_PADDING = 5.0;
  ...
  static Text normalText(String text,
    ...
    if (useColor || color != null) {
      if (color == null) {
        c = GeopaparazziColors.mainTextColor;
      } else {
        c = color;
      }
    } else {
      c = GeopaparazziColors.mainTextColorNeutral;
    }
    var textDecoration =
  ...
  static Text titleText(String text,
      {useColor = false, bold = false, color, textAlign = TextAlign.start}) {
    Color c;
    if (useColor || color != null) {
      if (color == null) {
        c = GeopaparazziColors.mainSelection;
      } else {
        c = color;
      }
    } else {
